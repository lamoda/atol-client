...
final class AgentInfo
{
     ...
     * @var AgentType
     *
     * @Serializer\Type("Enum<'Lamoda\AtolClient\V4\DTO\Register\AgentType'>")
     */
    private $type;
     ...
     *
     * @Serializer\Type("Lamoda\AtolClient\V4\DTO\Register\PayingAgent")
     */
    private $payingAgent;
     ...
     *
     * @Serializer\Type("Lamoda\AtolClient\V4\DTO\Register\ReceivePaymentsOperator")
     */
     ...
     *
     * @Serializer\Type("Lamoda\AtolClient\V4\DTO\Register\MoneyTransferOperator")
     */
