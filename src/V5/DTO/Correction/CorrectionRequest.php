...
use Lamoda\AtolClient\V5\DTO\Register\Service;
...
final class CorrectionRequest
{
     ...
     * @var Service|null
     *
     * @Serializer\Type("Lamoda\AtolClient\V5\DTO\Register\Service")
     */
    private $service;
     ...
     * @var Correction
     *
     * @Serializer\Type("Lamoda\AtolClient\V5\DTO\Correction\Correction")
     */
    private $correction;
